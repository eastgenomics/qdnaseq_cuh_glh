## Majority of the code is copied from qDNASeq_analysis.Rmd
## Seven cases of FF with qDNASeq & ACE outputs
...
sWGS_vs_WGS <- function(Case_WGS, metadata, sample, copynumber_df, mydir, subfolder){
  ...
  write.table(Case_truthvspredicted_df, 
              file = paste(mydir,"/", subfolder, "/", sample, "_", tool ,"_TP_FP_FN.tsv", sep =""),
